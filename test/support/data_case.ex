defmodule Dialectic.DataCase do
  @moduledoc """
  ...
  by setting `use Dialectic.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(Dialectic.Repo, shared: not tags[:async])
