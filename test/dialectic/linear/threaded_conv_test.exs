defmodule Dialectic.Linear.ThreadedConvTest do
  ...
  setup do
    ...
    :digraph.add_vertex(graph, root, %Vertex{
      id: root,
    ...
    :digraph.add_vertex(graph, child1, %Vertex{
      id: child1,
      content: "Child 1",
      class: "response",
      user: "ai"
    ...
    :digraph.add_vertex(graph, child2, %Vertex{
      id: child2,
      content: "Child 2",
      class: "user",
      user: "user1"
    ...
    :digraph.add_vertex(graph, grandchild, %Vertex{
      id: grandchild,
      content: "Grandchild",
      class: "response",
      user: "ai"
  ...
  describe "process_thread/5" do
    test "processes a thread with correct indentation", %{graph: graph} do
      ...
      assert nodes_by_id["1"] == 0
      # Child1 should have indent 1
      assert nodes_by_id["2"] == 1
      # Child2 should have indent 1
      assert nodes_by_id["3"] == 1
      # Grandchild should have indent 2
      assert nodes_by_id["4"] == 2
    end
  end
