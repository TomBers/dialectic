defmodule Graph.SiblingsTest do
  ...
  test "can get parent and child" do
    ...
    node = GraphManager.find_node_by_id(@graph_id, "4")
    ...
    node = GraphManager.find_node_by_id(@graph_id, "6")
    siblings = Siblings.sort_siblings(node, @graph_id)
    ...
    last_node = GraphManager.find_node_by_id(@graph_id, "an3")
    {_, graph} = GraphManager.get_graph(@graph_id)
