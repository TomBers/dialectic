    ...
    <div>
      ...
      >
        ...
        <span class="contents" data-role="action-buttons-group">
          <button
            type="button"
            class="inline-flex flex-row items-center justify-center gap-1.5 px-3 py-1.5 shadow-sm ring-1 ring-inset ring-black/10 bg-orange-500 text-white rounded-md transition-all hover:bg-orange-600 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            type="button"
            class="inline-flex flex-row items-center justify-center gap-1.5 px-3 py-1.5 shadow-sm ring-1 ring-inset ring-black/10 text-white rounded-md transition-all bg-gradient-to-r from-emerald-500 to-rose-500 hover:from-emerald-600 hover:to-rose-600 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            type="button"
            class="inline-flex flex-row items-center justify-center gap-1.5 px-3 py-1.5 shadow-sm ring-1 ring-inset ring-black/10 bg-violet-500 text-white rounded-md transition-all hover:bg-violet-600 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            phx-click={
          ...
          <button
            type="button"
            class="hidden inline-flex flex-row items-center justify-center gap-1.5 px-3 py-1.5 shadow-sm ring-1 ring-inset ring-black/10 bg-cyan-500 text-white rounded-md transition-all hover:bg-cyan-600 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            ...
            class={[
              "inline-flex flex-row items-center justify-center gap-1.5 px-3 py-1.5 shadow-sm ring-1 ring-inset ring-black/10 rounded-md transition-all disabled:opacity-50 disabled:cursor-not-allowed",
