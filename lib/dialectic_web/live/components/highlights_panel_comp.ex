defmodule DialecticWeb.HighlightsPanelComp do
  ...
  defp link_type_icon("analogy"), do: "hero-arrows-right-left"
  defp link_type_icon("steel_man"), do: "hero-star"
  defp link_type_icon("what_if"), do: "hero-question-mark-circle"
  defp link_type_icon("simplify"), do: "hero-sparkles"
  defp link_type_icon("second_order"), do: "hero-arrow-path"
  ...
  defp link_type_color("analogy"), do: "text-emerald-500"
  defp link_type_color("steel_man"), do: "text-yellow-500"
  defp link_type_color("what_if"), do: "text-fuchsia-500"
  defp link_type_color("simplify"), do: "text-orange-500"
  defp link_type_color("second_order"), do: "text-slate-500"
  ...
  defp link_type_label("analogy"), do: "Analogy"
  defp link_type_label("steel_man"), do: "Steel Man"
  defp link_type_label("what_if"), do: "What If"
  defp link_type_label("simplify"), do: "Simplify"
  defp link_type_label("second_order"), do: "Second Order"
