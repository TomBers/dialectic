defmodule DialecticWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 right-2 mr-2 w-80 sm:w-96 z-[10000] rounded-lg p-3 ring-1",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DialecticWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DialecticWeb.Gettext, "errors", msg, opts)
    end
  end
