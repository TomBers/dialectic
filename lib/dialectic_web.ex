defmodule DialecticWeb do
  ...
  def static_paths, do: ~w(assets fonts images uploads robots.txt llms.txt)
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: DialecticWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {DialecticWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      import DialecticWeb.Utils.TagHelpers, only: [tag_label: 1]
