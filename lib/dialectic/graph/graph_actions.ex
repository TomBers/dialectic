defmodule Dialectic.Graph.GraphActions do
  ...
  def says_who({graph_id, node, user, live_view_topic}, opts \\ []) do
    ...
    GraphManager.add_child(
      graph_id,
      [node],
      fn n -> LlmInterface.gen_says_who(node, n, graph_id, live_view_topic, content_override) end,
      "says_who",
      user
    )
  end
  ...
  def analogy({graph_id, node, user, live_view_topic}, opts \\ []) do
    ...
    GraphManager.add_child(
      graph_id,
      [node],
      fn n -> LlmInterface.gen_analogy(node, n, graph_id, live_view_topic, content_override) end,
      "analogy",
      user
    )
  end
  ...
  def what_if({graph_id, node, user, live_view_topic}, opts \\ []) do
    ...
    GraphManager.add_child(
      graph_id,
      [node],
      fn n -> LlmInterface.gen_what_if(node, n, graph_id, live_view_topic, content_override) end,
      "what_if",
      user
    )
  end
  ...
  def simplify({graph_id, node, user, live_view_topic}, opts \\ []) do
    ...
    GraphManager.add_child(
      graph_id,
      [node],
      fn n -> LlmInterface.gen_simplify(node, n, graph_id, live_view_topic, content_override) end,
      "simplify",
      user
    )
  end
