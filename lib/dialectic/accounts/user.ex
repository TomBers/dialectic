defmodule Dialectic.Accounts.User do
  ...
  This changeset is used when a user registers or logs in via OAuth providers like Google.
  It does not require a password and automatically confirms the user.
  """
