defmodule Dialectic.Responses.Modes do
  ...
  - Form: Markdown. Begin with exactly one H2 title (##) as the first line that summarizes the answer based on the user's request and the provided Context; do not use generic labels like “Response”, “Selection”, “Synthesis”, “Thesis”, “Antithesis”, “Related ideas”, or “Deepdive”. Keep it concise and meaningful.
