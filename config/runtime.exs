...
#
#     PHX_SERVER=true bin/dialectic start
#
...
if config_env() == :prod do
  ...
  config :dialectic, Dialectic.Repo,
    ...
    # Prevent idle connection drops on Fly.io
    after_connect: {Postgrex, :query!, ["SET application_name = 'dialectic'", []]},
    prepare: :unnamed
  ...
  config :dialectic, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :dialectic, Dialectic.Mailer,
...
# Configure OAuth at runtime to ensure environment variables are read when the app starts
...
# Configure encryption key for sensitive data (OAuth tokens, etc.)
